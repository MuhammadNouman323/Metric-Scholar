<x-admin>
    <div class="p-6 md:p-10 lg:p-12 pb-24 max-w-[1400px] mx-auto min-h-screen">
        ...
        <div
            class="bg-white rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-6 md:p-8 mb-8 relative overflow-hidden">
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div class="max-w-3xl">
                    <div class="flex flex-wrap items-center gap-3 mb-4">
                        <span
                            class="inline-flex items-center rounded-full bg-[#eef2ff] px-3 py-1 text-[11px] font-bold tracking-[0.14em] text-[#0e48c1]">{{ $department['departmentCode'] }}</span>
        ...
        <div
            class="flex items-center gap-8 border-b border-gray-100 mb-8 text-sm font-semibold text-gray-500 overflow-x-auto">
            <a href="{{ route('admin.departments.show', ['department' => $department['slug'], 'section' => 'overview']) }}"
                class="pb-4 whitespace-nowrap {{ $activeSection === 'overview' ? 'border-b-2 border-[#0e48c1] text-[#0e48c1]' : '' }}">Department
                Overview</a>
            <a href="{{ route('admin.departments.show', ['department' => $department['slug'], 'section' => 'faculty']) }}"
                class="pb-4 whitespace-nowrap {{ $activeSection === 'faculty' ? 'border-b-2 border-[#0e48c1] text-[#0e48c1]' : '' }}">Faculty
                Roster</a>
            <a href="{{ route('admin.departments.show', ['department' => $department['slug'], 'section' => 'enrollment']) }}"
                class="pb-4 whitespace-nowrap {{ $activeSection === 'enrollment' ? 'border-b-2 border-[#0e48c1] text-[#0e48c1]' : '' }}">Student
                Enrollment</a>
        </div>
        ...
        @if ($activeSection === 'overview')
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
                <div class="xl:col-span-2 space-y-6">
                    <div
                        class="bg-white rounded-[1.75rem] border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-6 md:p-7">
                        <div class="flex items-center justify-between gap-4 mb-5">
                            ...
                            <span
                                class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-[11px] font-bold text-emerald-600">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between gap-4 mb-6">
                            ...
                            <a href="{{ route('admin.departments.show', ['department' => $department['slug'], 'section' => 'faculty']) }}"
                                class="text-sm font-bold text-[#0e48c1]">View Roster</a>
                        </div>
                            ...
                            @forelse (array_slice($department['faculty'], 0, 2) as $member)
                                <div
                                    ...
                                    <div class="flex items-center gap-4 min-w-0">
                                        <div
                                            class="h-12 w-12 rounded-full bg-[#eff4ff] flex items-center justify-center text-sm font-bold text-[#0e48c1] shrink-0">
                                            {{ $member['initials'] }}
                                        </div>
                                        <div class="min-w-0">
                                            <h3 class="text-sm font-bold text-gray-900 truncate">{{ $member['name'] }}
                                            </h3>
                ...
                <div class="space-y-6">
                    <div
                        class="rounded-[1.75rem] border-l-4 border-[#0e48c1] bg-white p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)]">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="rounded-2xl bg-white p-4 shadow-sm border border-gray-100">
                                            <div class="flex items-center justify-between gap-4 mb-1">
                                                <h3 class="text-sm font-bold text-gray-900">{{ $activity['title'] }}
                                                </h3>
                                                <span
                                                    class="text-xs font-semibold text-gray-400 whitespace-nowrap">{{ $activity['time'] }}</span>
                                            </div>
        ...
        @elseif ($activeSection === 'faculty')
            <div
                ...
                <div class="flex items-center justify-between gap-4 mb-6">
                    ...
                    <span class="text-sm font-medium text-gray-500">{{ count($department['faculty']) }} faculty members
                        listed</span>
                </div>
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center gap-3 min-w-0">
                                    <div
                                        class="h-11 w-11 rounded-full bg-[#eff4ff] flex items-center justify-center text-sm font-bold text-[#0e48c1] shrink-0">
                                        {{ $member['initials'] }}
                                    </div>
                                    <div class="min-w-0">
                                        <h3 class="text-base font-bold text-gray-900 truncate">{{ $member['name'] }}
                                        </h3>
                                        <p class="text-sm font-medium text-[#0e48c1] truncate">{{ $member['role'] }}
                                        </p>
                                    </div>
                                </div>
        ...
        @else
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div
                    class="xl:col-span-2 bg-white rounded-[1.75rem] border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-6 md:p-7">
                    <div class="flex items-center justify-between gap-4 mb-6">
                        <h2 class="text-[18px] font-bold text-gray-900">Student Enrollment</h2>
                        <span class="text-sm font-medium text-gray-500">{{ count($department['students']) }} students
                            listed</span>
                    </div>
                                    ...
                                    <div class="flex items-center gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            <h3 class="text-base font-bold text-gray-900 truncate">
                                                {{ $student['name'] }}</h3>
                                            <p class="text-sm font-medium text-[#0e48c1] truncate">
                                                {{ $student['program'] }}</p>
                                        </div>
                                    </div>
                                    <button class="text-gray-400 hover:text-gray-700" aria-label="More options">
