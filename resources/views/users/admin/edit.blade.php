<x-admin>
    <div class="p-6 md:p-10 lg:p-12 pb-24 max-w-[1000px] mx-auto min-h-screen space-y-8">
        ...
        <div class="flex items-center gap-4">
            <a href="{{ $user->role === \App\Enums\Role::Faculty ? route('admin.faculty') : route('admin.students') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="relative">
                            ...
                            <select name="role"
                                ...
                                <option value="{{ \App\Enums\Role::Student->value }}" @selected(old('role', $user->role->value) === \App\Enums\Role::Student->value)>Student</option>
                                <option value="{{ \App\Enums\Role::Faculty->value }}" @selected(old('role', $user->role->value) === \App\Enums\Role::Faculty->value)>Faculty</option>
                                <option value="{{ \App\Enums\Role::Admin->value }}" @selected(old('role', $user->role->value) === \App\Enums\Role::Admin->value)>Admin</option>
                            </select>
