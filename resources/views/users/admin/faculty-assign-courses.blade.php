<x-admin>
    ...
    <div class="p-6 md:p-10 lg:p-12 pb-24 max-w-[1400px] mx-auto min-h-screen">
        ...
        <div class="text-sm font-medium text-gray-500 mb-5">
            <a href="{{ route('admin.faculty') }}" class="hover:text-[#0e48c1]">Faculty</a>
        ...
        <div class="flex items-start gap-4 mb-8">
            <a href="{{ route('admin.faculty') }}" class="text-gray-500 hover:text-gray-900 transition-colors mt-1.5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[1.5rem] border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-6 flex items-center gap-6">
                    ...
                    <div class="grid grid-cols-3 gap-6 flex-1">
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-900">{{ $faculty->department ?? 'N/A' }}</p>
                        </div>
                        <div>
                ...
                {{-- Available Courses --}}
                <form id="assign-form" action="{{ route('admin.faculty.store-assignments', $faculty) }}" method="POST">
                    @csrf
                    ...
                    <div>
                        ...
                        @if(session('success'))
                            <div class="mb-4 flex items-center gap-3 bg-green-50 border border-green-200 text-green-700 rounded-xl px-4 py-3 text-sm font-medium">
