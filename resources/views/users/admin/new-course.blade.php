    ...
    <div class="p-6 md:p-10 lg:p-12 pb-24 max-w-[1400px] mx-auto min-h-screen">
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="text-sm font-medium text-gray-500">
                <a href="/admin/courses" class="hover:text-[#0e48c1]">Courses</a>
            ...
            <div class="bg-white border border-gray-100 rounded-[1.5rem] overflow-hidden shadow-sm">
                ...
                <form action="{{ route('admin.courses.store') }}" method="POST" class="p-7 md:p-9 space-y-8">
                    @csrf
                    ...
                    <section class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="title" name="title" type="text" value="{{ old('title') }}"
                                ...
                                class="w-full border border-gray-100 bg-[#f8fafc] rounded-xl px-4 py-3 text-[14px] text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0e48c1] focus:bg-white @error('title') border-red-400 @enderror" />
                            @error('title')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <input id="code" name="code" type="text" value="{{ old('code') }}" placeholder="e.g. CS-101"
                                    class="w-full border border-gray-100 bg-[#f8fafc] rounded-xl px-4 py-3 text-[14px] text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0e48c1] focus:bg-white @error('code') border-red-400 @enderror" />
                                @error('code')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="space-y-2">
                                ...
                                <select id="department" name="department"
                                    class="w-full border border-gray-100 bg-[#f8fafc] rounded-xl px-4 py-3 text-[14px] text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0e48c1] focus:bg-white @error('department') border-red-400 @enderror">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <select id="semester" name="semester"
                                    ...
                                    <option value="Spring 2025" {{ old('semester') === 'Spring 2025' ? 'selected' : '' }}>Spring 2025</option>
                                    <option value="Fall 2025" {{ old('semester') === 'Fall 2025' ? 'selected' : '' }}>Fall 2025</option>
                                </select>
                                @error('semester')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="space-y-2">
                                ...
                                <input id="credit_hours" name="credit_hours" type="number" min="1" max="8"
                                    value="{{ old('credit_hours') }}" placeholder="3"
                                    class="w-full border border-gray-100 bg-[#f8fafc] rounded-xl px-4 py-3 text-[14px] text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0e48c1] focus:bg-white @error('credit_hours') border-red-400 @enderror" />
                                @error('credit_hours')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
