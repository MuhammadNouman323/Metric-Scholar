<x-student>
    <div class="p-6 md:p-10 lg:p-12 pb-24 max-w-[1400px] mx-auto min-h-screen">
        ...
        @if (session('success'))
            <div class="flash-message mb-8 rounded-2xl border border-green-200 bg-green-50 p-4 text-sm font-semibold text-green-700 shadow-sm">
        ...
        @if (session('error'))
            <div class="flash-message mb-8 rounded-2xl border border-red-200 bg-red-50 p-4 text-sm font-semibold text-red-700 shadow-sm">
                <div class="flex items-center gap-2">
