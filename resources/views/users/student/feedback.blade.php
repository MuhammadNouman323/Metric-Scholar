    ...
    <script>
        ...
        async function loadCourseDetails(courseId) {
            ...
            try {
                ...
                document.getElementById('course-semester').innerHTML = `<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg> ${(() => { const s = data.course.semester || ''; const season = s.split(' ')[0]; const part = season === 'Spring' ? '1st Semester' : season === 'Fall' ? '2nd Semester' : season === 'Summer' ? 'Summer Semester' : ''; return part ? s + ' — ' + part : (s || 'Current Semester'); })()}`;
