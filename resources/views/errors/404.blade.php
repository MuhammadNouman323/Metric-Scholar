<x-layout>
    <div class="min-h-screen flex items-center justify-center bg-white px-6">
        <div class="text-center max-w-lg">
            <h1 class="text-[120px] font-bold text-gray-100 leading-none mb-4">404</h1>
            <h2 class="text-2xl font-bold text-gray-900 mb-3">Page not found</h2>
            <p class="text-gray-500 font-medium mb-8">The page you are looking for does not exist or has been moved.</p>
