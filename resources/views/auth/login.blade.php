                    ...
                    <form method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="mb-6 relative">
                            ...
                            <div class="relative flex items-center bg-[#f8fafc] rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-[#0e48c1] focus-within:bg-white transition-all border border-transparent focus-within:border-blue-200">
                                ...
                                <input type="password" class="w-full bg-transparent px-3 py-3.5 pr-12 text-gray-900 font-medium placeholder:text-gray-400 placeholder:font-normal focus:outline-none text-[15px] tracking-widest" placeholder="••••••••">
                        ...
                        <div class="mb-8 flex items-center mt-1">
                            <input id="remember" name="remember" type="checkbox" class="w-4 h-4 text-[#0e48c1] bg-white border-gray-300 rounded focus:ring-[#0e48c1] focus:ring-2 cursor-pointer transition-colors shadow-sm">
