                ...
                <div class="relative z-10 flex flex-col h-full items-start">
                    ...
                    <div class="max-w-[420px]">
                        ...
                        <p class="text-gray-600 text-base sm:text-[17px] leading-relaxed max-w-sm font-medium">
                            Password reset links are time-limited for your security. Request a new link to continue.
                        </p>
                    </div>
                    ...
                    <div class="bg-white/50 backdrop-blur-md rounded-2xl p-4 lg:p-5 border border-white/60 max-w-[340px] shadow-sm w-full">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 font-medium">Reset links expire after 60 minutes for your protection.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full max-w-[440px] mx-auto">
                    ...
                    <div class="mb-10">
                        <div class="flex items-center justify-between mb-2">
                            <span class="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-red-500 bg-red-50 px-3 py-1.5 rounded-full">
                        ...
                        <h2 class="text-[32px] font-bold text-gray-900 mb-2">
                            @if($reason === 'expired')
                        ...
                        <p class="text-gray-500 font-medium text-[15px]">
                            @if($reason === 'expired')
                                The password reset link has passed its 60-minute validity window. For security, it can no longer be used.
                            @else
                                The password reset link you followed is not valid. It may have already been used or replaced.
                            @endif
                        </p>
                    </div>
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-8">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-amber-800">What to do next</p>
                                <p class="text-sm text-amber-700 mt-1">Go back to the forgot password page and request a fresh reset link. Check your inbox for the new email.</p>
                            </div>
                        </div>
                    </div>
