    ...
    <div class="flex h-screen bg-[#f8fafc] font-sans antialiased text-gray-900 overflow-hidden">
        ...
        <aside
            ...
            <nav class="flex-1 overflow-y-auto space-y-1 text-[14px] font-semibold text-gray-500 pb-4">
                ...
                <a href="#"
                    class="flex items-center px-8 py-3.5 hover:bg-gray-100 hover:text-gray-900 transition-colors border-l-4 border-transparent mt-2">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="px-6 pb-8 border-t border-gray-100 pt-6 shrink-0">
                ...
                <a href="#"
                    class="flex items-center px-3 py-2 text-gray-500 hover:text-gray-900 text-[14px] font-medium transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
