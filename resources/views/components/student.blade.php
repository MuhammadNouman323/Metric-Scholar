        ...
        <aside
            ...
            <nav class="flex-1 overflow-y-auto space-y-0.5 text-[14px] font-semibold text-gray-500 pb-4">
                ...
                <a href="/student/teachers"
                    class="{{ request()->is('student/teachers') ? 'text-[#0e48c1] bg-blue-50/70 border-l-4 border-[#0e48c1]' : 'hover:bg-gray-100 hover:text-gray-900 border-l-4 border-transparent' }} flex items-center px-6 py-3.5 transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
