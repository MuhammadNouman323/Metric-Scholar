        ...
        <aside id="sidebar-drawer"
            ...
            <div class="h-20 flex items-center justify-between px-6 shrink-0">
                ...
                <button type="button" data-sidebar-close aria-label="Close navigation menu"
                    class="lg:hidden w-9 h-9 flex items-center justify-center rounded-xl text-slate-400 hover:text-slate-900 hover:bg-slate-100/80 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0e48c1]/40">
