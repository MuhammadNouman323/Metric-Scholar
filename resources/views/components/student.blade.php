<x-layout>
    ...
    <div class="flex h-screen bg-gradient-to-br from-slate-50 via-slate-50 to-blue-50/30 font-sans antialiased text-slate-900 overflow-hidden">
        ...
        <aside id="sidebar-drawer"
            ...
            <!-- Logo -->
            <div class="relative h-20 flex items-center justify-between px-6 shrink-0">
                <a href="/student/dashboard" class="flex items-center group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0e48c1]/40 rounded-xl">
                    <div class="relative mr-3">
                        <div class="w-9 h-9 bg-gradient-to-br from-[#0e48c1] to-[#3d6ae8] rounded-xl flex items-center justify-center text-white
                        ...
                        <span class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-400 border-2 border-white rounded-full shadow-[0_0_8px_rgba(52,211,153,0.5)] animate-pulse"></span>
                    </div>
                    <div>
                        <div class="font-bold text-[14.5px] tracking-tight leading-none text-slate-900 mb-1">Scholar Metric</div>
                        <div class="text-[8.5px] font-bold text-[#0e48c1]/60 tracking-[0.2em] uppercase">Academic Curator</div>
                    </div>
                </a>
                <button type="button" data-sidebar-close aria-label="Close navigation menu"
                    class="lg:hidden w-9 h-9 flex items-center justify-center rounded-xl text-slate-400 hover:text-slate-900 hover:bg-slate-100/80 transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0e48c1]/40 active:scale-90">
            ...
            <!-- Bottom Section -->
            <div class="relative px-4 pb-5 pt-4 border-t border-slate-100/70 shrink-0">
                <!-- Profile card -->
                <a href="/student/profile"
                    class="profile-card flex items-center gap-3 bg-white/80 border border-slate-100/80 rounded-2xl p-2.5 mb-3 shadow-sm
                ...
                <a href="#"
                    class="group flex items-center px-2.5 py-2 rounded-xl text-slate-500 hover:text-slate-900 hover:bg-white/80 text-[12.5px] font-semibold transition-all duration-200 mb-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0e48c1]/40 active:scale-[0.98]">
                ...
                <form method="POST" action="{{ route('logout') }}" class="mb-2">
                    @csrf
                    <button type="submit"
                        class="w-full flex items-center px-2.5 py-2 rounded-xl text-slate-500 hover:text-red-600 hover:bg-red-50/60 text-[12.5px] font-semibold transition-all duration-200 cursor-pointer bg-transparent border-0 text-left group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/40 active:scale-[0.98]">
                        <svg class="w-4 h-4 mr-2.5 transition-transform duration-200 group-hover:-translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="px-2.5 pt-1">
                    <p class="text-[9px] font-bold text-[#0e48c1]/50 uppercase tracking-widest mb-1.5">Status</p>
                    <div class="flex items-center gap-1.5">
                        <span class="relative flex h-2 w-2">
                            <span class="absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75 animate-ping"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-500 shadow-[0_0_6px_rgba(52,211,153,0.5)]"></span>
                        </span>
