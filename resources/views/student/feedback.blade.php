<x-student>
    ...
    <div class="bg-[#f0f4ff] border-l-4 border-[#0e48c1] px-6 py-3.5 flex items-center gap-3">
        ...
        <p class="text-[13px] font-semibold text-gray-700">Your feedback is 100% anonymous and used only for institutional improvement.</p>
    </div>
    ...
    <div class="p-6 md:p-10 pb-24 max-w-[1100px] mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex items-center gap-3">
                <div class="relative">
                    ...
                    <input type="text" placeholder="Search courses..." class="bg-gray-50 border border-gray-200 rounded-xl pl-9 pr-4 py-2.5 text-[13px] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0e48c1]/20 w-48">
                </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-8 gap-4">
            ...
            <div class="flex items-center gap-3 bg-[#f8fafc] rounded-2xl p-3 border border-gray-100 shrink-0">
                <img src="https://i.pravatar.cc/80?img=69" alt="Dr. Helena Vance" class="w-12 h-12 rounded-xl object-cover">
                <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                ...
                <div class="flex gap-2">
                    @for ($i = 1; $i <= 5; $i++)
                        <svg class="w-8 h-8 cursor-pointer transition-transform hover:scale-110 {{ $i <= 4 ? 'text-[#0e48c1]' : 'text-gray-200' }} fill-current" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                ...
                <div class="flex gap-2">
                    @for ($i = 1; $i <= 5; $i++)
                        <svg class="w-8 h-8 cursor-pointer transition-transform hover:scale-110 {{ $i <= 3 ? 'text-[#0e48c1]' : 'text-gray-200' }} fill-current" viewBox="0 0 24 24">
                            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                        </svg>
                    @endfor
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                ...
                <div class="flex gap-2">
                    @for ($i = 1; $i <= 5; $i++)
                        <svg class="w-8 h-8 cursor-pointer transition-transform hover:scale-110 text-[#0e48c1] fill-current" viewBox="0 0 24 24">
                            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                        </svg>
                    @endfor
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <svg class="w-5 h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
                </div>
                <div class="flex gap-2">
                    @for ($i = 1; $i <= 5; $i++)
                        <svg class="w-8 h-8 cursor-pointer transition-transform hover:scale-110 {{ $i <= 4 ? 'text-[#0e48c1]' : 'text-gray-200' }} fill-current" viewBox="0 0 24 24">
        ...
        <div class="flex items-center justify-end gap-4">
            ...
            <button class="flex items-center gap-2 bg-[#0e48c1] text-white px-7 py-3.5 rounded-xl text-[14px] font-bold hover:bg-blue-800 transition-colors shadow-[0_4px_12px_rgba(14,72,193,0.25)]">
                Submit Evaluation
