...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/user/{user}', [AdminController::class, 'showUser'])->name('admin.users.show');
        ...
        Route::delete('/user/{user}', [AdminController::class, 'destroyUser'])->name('admin.users.destroy');
